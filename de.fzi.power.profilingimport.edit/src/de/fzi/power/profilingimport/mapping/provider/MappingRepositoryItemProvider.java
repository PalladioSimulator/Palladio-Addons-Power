...
/**
 * This is the item provider adapter for a {@link de.fzi.power.profilingimport.mapping.MappingRepository} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MappingRepositoryItemProvider extends IdentifierItemProvider {
    /**
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(MappingPackage.Literals.MAPPING_REPOSITORY__MAPPINGS);
            childrenFeatures.add(MappingPackage.Literals.MAPPING_REPOSITORY__MARKER_LOG);
        }
    ...
    public String getText(Object object) {
        String label = ((MappingRepository)object).getId();
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (MappingPackage.Literals.MAPPING_REPOSITORY__MAPPINGS,
                 MappingFactory.eINSTANCE.createMetricToCsvMapping()));

        newChildDescriptors.add
            (createChildParameter
                (MappingPackage.Literals.MAPPING_REPOSITORY__MARKER_LOG,
                 MappingFactory.eINSTANCE.createMarkerLog()));
    }
