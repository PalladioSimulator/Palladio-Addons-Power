...
public final class ExtendedAddExpression extends AddExpression {

    static {
        addTypePair(ExtendedAddExpression.class, CustomExpressionContext.MEASURED_VALUES_COMPOSITE_TYPE, Type.DOUBLE,
                CustomExpressionContext.MEASURED_VALUES_COMPOSITE_TYPE);
        addTypePair(ExtendedAddExpression.class, Type.DOUBLE, CustomExpressionContext.MEASURED_VALUES_COMPOSITE_TYPE,
                CustomExpressionContext.MEASURED_VALUES_COMPOSITE_TYPE);

        addTypePair(ExtendedAddExpression.class, CustomExpressionContext.MEASURED_VALUES_COMPOSITE_TYPE, Type.INTEGER,
                CustomExpressionContext.MEASURED_VALUES_COMPOSITE_TYPE);
        addTypePair(ExtendedAddExpression.class, Type.INTEGER, CustomExpressionContext.MEASURED_VALUES_COMPOSITE_TYPE,
                CustomExpressionContext.MEASURED_VALUES_COMPOSITE_TYPE);
        addTypePair(ExtendedAddExpression.class, CustomExpressionContext.MEASURED_VALUES_COMPOSITE_TYPE, Type.LONG,
                CustomExpressionContext.MEASURED_VALUES_COMPOSITE_TYPE);
        addTypePair(ExtendedAddExpression.class, Type.LONG, CustomExpressionContext.MEASURED_VALUES_COMPOSITE_TYPE,
                CustomExpressionContext.MEASURED_VALUES_COMPOSITE_TYPE);

        addTypePair(ExtendedAddExpression.class, Type.DOUBLE, Type.DOUBLE, Type.DOUBLE);
        addTypePair(ExtendedAddExpression.class, Type.LONG, Type.LONG, Type.LONG);
    }

    public ExtendedAddExpression() {
