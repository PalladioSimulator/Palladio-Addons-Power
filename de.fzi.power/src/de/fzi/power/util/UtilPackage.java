...
public interface UtilPackage extends EPackage {
    ...
    /**
     * The meta object id for the '<em>Dimensionless</em>' data type. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * Returns the meta object for data type '{@link javax.measure.quantity.Dimensionless
     * <em>Dimensionless</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
    ...
    interface Literals {
        ...
        /**
         * The meta object literal for the '<em>Dimensionless</em>' data type. <!-- begin-user-doc
         * --> <!-- end-user-doc -->
         *
         * @see javax.measure.quantity.Dimensionless
         * @see de.fzi.power.util.impl.UtilPackageImpl#getDimensionless()
