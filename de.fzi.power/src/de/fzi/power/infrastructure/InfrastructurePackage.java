...
public interface InfrastructurePackage extends EPackage {
	 ...
	 * @generated
	 */
	InfrastructurePackage eINSTANCE = de.fzi.power.infrastructure.impl.InfrastructurePackageImpl
			.init();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EClass POWER_CONSUMING_PROVIDING_ENTITY = eINSTANCE
				.getPowerConsumingProvidingEntity();
		 ...
		 * @generated
		 */
		EClass MOUNTED_POWER_DISTRIBUTION_UNIT = eINSTANCE
				.getMountedPowerDistributionUnit();
		 ...
		 * @generated
		 */
		EClass POWER_INFRASTRUCTURE_REPOSITORY = eINSTANCE
