 ...
 * </p>
 * <ul>
 * <li>{@link de.fzi.power.infrastructure.StatefulPowerConsumingResource#getPowerState
...
public interface StatefulPowerConsumingResource extends AbstractPowerConsumingResource {
     ...
     * begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Stateful Resource Power Binding</em>' reference isn't clear, there
     ...
     * Sets the value of the '
     * {@link de.fzi.power.infrastructure.StatefulPowerConsumingResource#getStatefulResourcePowerBinding
     * <em>Stateful Resource Power Binding</em>}' reference. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Stateful Resource Power Binding</em>' reference.
