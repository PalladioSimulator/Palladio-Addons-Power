...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Power Providing Entity</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public abstract class PowerProvidingEntityImpl extends EntityImpl implements PowerProvidingEntity {
    ...
    public PowerInfrastructureRepository getPowerInfrastructureModel() {
        if (eContainerFeatureID() != InfrastructurePackage.POWER_PROVIDING_ENTITY__POWER_INFRASTRUCTURE_MODEL)
            return null;
    ...
    public void setPowerInfrastructureModel(PowerInfrastructureRepository newPowerInfrastructureModel) {
        if (newPowerInfrastructureModel != eInternalContainer()
                || (eContainerFeatureID() != InfrastructurePackage.POWER_PROVIDING_ENTITY__POWER_INFRASTRUCTURE_MODEL && newPowerInfrastructureModel != null)) {
