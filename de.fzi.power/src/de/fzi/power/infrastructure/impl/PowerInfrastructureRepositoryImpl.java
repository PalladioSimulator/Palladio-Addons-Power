 ...
 * @generated
 */
public class PowerInfrastructureRepositoryImpl extends CDOObjectImpl implements
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case InfrastructurePackage.POWER_INFRASTRUCTURE_REPOSITORY__CONTAINED_POWER_PROVIDING_ENTITIES:
			return ((InternalEList<?>) getContainedPowerProvidingEntities())
	...
	public void eSet(int featureID, Object newValue) {
		...
		case InfrastructurePackage.POWER_INFRASTRUCTURE_REPOSITORY__CONTAINED_POWER_PROVIDING_ENTITIES:
			...
			getContainedPowerProvidingEntities().addAll(
					(Collection<? extends PowerProvidingEntity>) newValue);
			return;
		}
