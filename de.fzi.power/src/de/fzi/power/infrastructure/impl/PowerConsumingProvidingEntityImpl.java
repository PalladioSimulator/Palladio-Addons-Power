...
public abstract class PowerConsumingProvidingEntityImpl extends PowerConsumingEntityImpl
    ...
    public void setSuppliablePeakPower(Measure<?, Power> newSuppliablePeakPower) {
        eDynamicSet(InfrastructurePackage.POWER_CONSUMING_PROVIDING_ENTITY__SUPPLIABLE_PEAK_POWER,
    ...
    public void setPowerInfrastructureModel(PowerInfrastructureRepository newPowerInfrastructureModel) {
        eDynamicSet(InfrastructurePackage.POWER_CONSUMING_PROVIDING_ENTITY__POWER_INFRASTRUCTURE_MODEL,
    ...
    public void setDistributionPowerAssemblyContext(DistributionPowerBinding newDistributionPowerAssemblyContext) {
        eDynamicSet(InfrastructurePackage.POWER_CONSUMING_PROVIDING_ENTITY__DISTRIBUTION_POWER_ASSEMBLY_CONTEXT,
