...
public interface InfrastructureFactory extends EFactory {
    ...
    /**
     * Returns a new object of class '<em>Mounted Power Distribution Unit</em>'. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     *
    ...
    /**
     * Returns a new object of class '<em>Power Consuming Resource</em>'. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * Returns a new object of class '<em>Power Infrastructure Repository</em>'. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     *
