...
public class InfrastructureAdapterFactory extends AdapterFactoryImpl {
    ...
    protected InfrastructureSwitch<Adapter> modelSwitch = new InfrastructureSwitch<Adapter>() {
        ...
        @Override
        public Adapter casePowerConsumingProvidingEntity(PowerConsumingProvidingEntity object) {
        ...
        @Override
        public Adapter caseMountedPowerDistributionUnit(MountedPowerDistributionUnit object) {
            return createMountedPowerDistributionUnitAdapter();
        }

        @Override
        public Adapter caseAbstractPowerConsumingResource(AbstractPowerConsumingResource object) {
            return createAbstractPowerConsumingResourceAdapter();
        }

        @Override
        public Adapter casePowerInfrastructureRepository(PowerInfrastructureRepository object) {
            return createPowerInfrastructureRepositoryAdapter();
        }

        @Override
        public Adapter caseStatefulPowerConsumingResourceSet(StatefulPowerConsumingResourceSet object) {
            return createStatefulPowerConsumingResourceSetAdapter();
        }

        @Override
        public Adapter casePowerConsumingResourceSet(PowerConsumingResourceSet object) {
            return createPowerConsumingResourceSetAdapter();
        }
    ...
    /**
     * Creates a new adapter for an object of class '{@link de.fzi.power.infrastructure.StatefulPowerConsumingResourceSet <em>Stateful Power Consuming Resource Set</em>}'.
     * <!-- begin-user-doc -->
     ...
     * @generated
     */
    public Adapter createStatefulPowerConsumingResourceSetAdapter() {
        return null;
    }

    /**
     * Creates a new adapter for an object of class '{@link de.fzi.power.infrastructure.PowerConsumingResourceSet <em>Power Consuming Resource Set</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public Adapter createPowerConsumingResourceSetAdapter() {
        return null;
    }
