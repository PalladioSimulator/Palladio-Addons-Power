...
public class InfrastructureAdapterFactory extends AdapterFactoryImpl {
    ...
    protected InfrastructureSwitch<Adapter> modelSwitch = new InfrastructureSwitch<Adapter>() {
        ...
        @Override
        public Adapter caseAbstractPowerConsumingResource(final AbstractPowerConsumingResource object) {
            return InfrastructureAdapterFactory.this.createAbstractPowerConsumingResourceAdapter();
        }
        ...
        @Override
        public Adapter caseStatefulPowerConsumingResource(final StatefulPowerConsumingResource object) {
            return InfrastructureAdapterFactory.this.createStatefulPowerConsumingResourceAdapter();
        }
     ...
     * <em>Abstract Power Consuming Resource</em>}'. <!-- begin-user-doc --> This default
     * implementation returns null so that we can easily ignore cases; it's useful to ignore a case
     * when inheritance will catch all the cases anyway. <!-- end-user-doc -->
     *
     * @return the new adapter.
     ...
     * <em>Stateful Power Consuming Resource</em>}'. <!-- begin-user-doc --> This default
     * implementation returns null so that we can easily ignore cases; it's useful to ignore a case
     * when inheritance will catch all the cases anyway. <!-- end-user-doc -->
     *
     * @return the new adapter.
