...
public class InfrastructureSwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        ...
        case InfrastructurePackage.STATEFUL_POWER_CONSUMING_RESOURCE_SET: {
            StatefulPowerConsumingResourceSet statefulPowerConsumingResourceSet = (StatefulPowerConsumingResourceSet) theEObject;
            T result = caseStatefulPowerConsumingResourceSet(statefulPowerConsumingResourceSet);
            if (result == null)
                result = caseAbstractPowerConsumingResource(statefulPowerConsumingResourceSet);
            if (result == null)
                result = casePowerConsumingEntity(statefulPowerConsumingResourceSet);
            if (result == null)
                result = caseEntity(statefulPowerConsumingResourceSet);
            if (result == null)
                result = caseIdentifier(statefulPowerConsumingResourceSet);
            if (result == null)
                result = caseNamedElement(statefulPowerConsumingResourceSet);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case InfrastructurePackage.POWER_CONSUMING_RESOURCE_SET: {
            PowerConsumingResourceSet powerConsumingResourceSet = (PowerConsumingResourceSet) theEObject;
            T result = casePowerConsumingResourceSet(powerConsumingResourceSet);
            if (result == null)
                result = caseAbstractPowerConsumingResource(powerConsumingResourceSet);
            if (result == null)
                result = casePowerConsumingEntity(powerConsumingResourceSet);
            if (result == null)
                result = caseEntity(powerConsumingResourceSet);
            if (result == null)
                result = caseIdentifier(powerConsumingResourceSet);
            if (result == null)
                result = caseNamedElement(powerConsumingResourceSet);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
     ...
     * @generated
     */
    public T caseAbstractPowerConsumingResource(AbstractPowerConsumingResource object) {
        return null;
    }
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>Stateful Power Consuming Resource Set</em>'.
     * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Stateful Power Consuming Resource Set</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseStatefulPowerConsumingResourceSet(StatefulPowerConsumingResourceSet object) {
        return null;
    }

    /**
     * Returns the result of interpreting the object as an instance of '<em>Power Consuming Resource Set</em>'.
     * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Power Consuming Resource Set</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T casePowerConsumingResourceSet(PowerConsumingResourceSet object) {
        return null;
    }
