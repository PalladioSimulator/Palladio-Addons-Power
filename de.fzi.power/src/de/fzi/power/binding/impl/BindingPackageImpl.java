...
public class BindingPackageImpl extends EPackageImpl implements BindingPackage {
	...
	public static BindingPackage init() {
		if (isInited)
			return (BindingPackage) EPackage.Registry.INSTANCE
		...
		BindingPackageImpl theBindingPackage = (BindingPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof BindingPackageImpl ? EPackage.Registry.INSTANCE
		...
		EPackage.Registry.INSTANCE.put(BindingPackage.eNS_URI,
				theBindingPackage);
	...
	public EReference getFixedFactorValue_BoundFactor() {
		return (EReference) fixedFactorValueEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public EAttribute getFixedFactorValue_Value() {
		return (EAttribute) fixedFactorValueEClass.getEStructuralFeatures()
				.get(1);
	}
	...
	public EReference getPowerBindingRepository_PowerBindings() {
		return (EReference) powerBindingRepositoryEClass
	...
	public EReference getResourcePowerBinding_ResourcePowerModelSpecification() {
		return (EReference) resourcePowerBindingEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public void createPackageContents() {
		...
		createEReference(fixedFactorValueEClass,
				FIXED_FACTOR_VALUE__BOUND_FACTOR);
		createEAttribute(fixedFactorValueEClass, FIXED_FACTOR_VALUE__VALUE);
		createEReference(fixedFactorValueEClass,
				FIXED_FACTOR_VALUE__POWER_BINDING);

		powerBindingRepositoryEClass = createEClass(POWER_BINDING_REPOSITORY);
		createEReference(powerBindingRepositoryEClass,
				POWER_BINDING_REPOSITORY__POWER_BINDINGS);
	...
	public void initializePackageContents() {
		...
		fixedFactorValueEClass.getESuperTypes().add(
		...
		initEClass(fixedFactorValueEClass, FixedFactorValue.class,
				"FixedFactorValue", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getFixedFactorValue_BoundFactor(),
				theSpecificationPackage.getFixedFactor(), null, "boundFactor",
				null, 1, 1, FixedFactorValue.class, !IS_TRANSIENT,
		...
		g1.getETypeArguments().add(g2);
		initEAttribute(getFixedFactorValue_Value(), g1, "value", null, 0, 1,
				FixedFactorValue.class, !IS_TRANSIENT, !IS_VOLATILE,
		...
		initEClass(powerBindingRepositoryEClass, PowerBindingRepository.class,
				...
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPowerBindingRepository_PowerBindings(),
				this.getPowerBinding(),
				this.getPowerBinding_PowerBindingRepository(), "powerBindings",
				null, 0, -1, PowerBindingRepository.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(powerBindingEClass, PowerBinding.class, "PowerBinding",
				IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPowerBinding_PowerBindingRepository(),
				this.getPowerBindingRepository(),
				this.getPowerBindingRepository_PowerBindings(),
				"powerBindingRepository", null, 0, 1, PowerBinding.class,
		...
		initEReference(
				...
				theSpecificationPackage.getResourcePowerModelSpecification(),
				null, "resourcePowerModelSpecification", null, 1, 1,
				ResourcePowerBinding.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(distributionPowerBindingEClass,
				DistributionPowerBinding.class, "DistributionPowerBinding",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getDistributionPowerBinding_DistributionPowerModel(),
				theSpecificationPackage
						.getDistributionPowerModelSpecification(), null,
