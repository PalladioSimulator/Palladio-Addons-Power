 ...
 * <ul>
 *   <li>{@link de.fzi.power.binding.PowerState#getStatefulResourcePowerBinding <em>Stateful Resource Power Binding</em>}</li>
...
public interface PowerState extends Entity {
	...
	/**
	 * Sets the value of the '{@link de.fzi.power.binding.PowerState#getBinding <em>Binding</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the value of the '<em><b>Stateful Resource Power Binding</b></em>' container reference.
	 * It is bidirectional and its opposite is '{@link de.fzi.power.binding.StatefulResourcePowerBinding#getPowerStates <em>Power States</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Stateful Resource Power Binding</em>' container reference isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	...
	/**
	 * Sets the value of the '{@link de.fzi.power.binding.PowerState#getStatefulResourcePowerBinding <em>Stateful Resource Power Binding</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Stateful Resource Power Binding</em>' container reference.
