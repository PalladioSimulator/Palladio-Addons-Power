...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Fixed Factor Value</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
...
public interface FixedFactorValue extends EObject, Identifier {
     ...
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Bound Factor</em>' reference isn't clear,
    ...
    /**
     * Sets the value of the '{@link de.fzi.power.binding.FixedFactorValue#getBoundFactor <em>Bound Factor</em>}' reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @model dataType="org.palladiosimulator.edp2.models.ExperimentData.EJSMeasure<org.eclipse.emf.ecore.EDoubleObject, de.fzi.power.util.Power>"
     * @generated
     */
    Measure<Double, Power> getValue();

    /**
     * Sets the value of the '{@link de.fzi.power.binding.FixedFactorValue#getValue <em>Value</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Power Binding</em>' container reference isn't clear,
     * there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
