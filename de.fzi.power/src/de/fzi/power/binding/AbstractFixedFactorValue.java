 ...
 * </p>
 * <ul>
 * <li>{@link de.fzi.power.binding.AbstractFixedFactorValue#getBoundFactor <em>Bound Factor</em>}
 * </li>
 * <li>{@link de.fzi.power.binding.AbstractFixedFactorValue#getValue <em>Value</em>}</li>
 * <li>{@link de.fzi.power.binding.AbstractFixedFactorValue#getPowerBinding <em>Power Binding</em>}
 * </li>
 * </ul>
 *
...
public interface AbstractFixedFactorValue<Q extends Quantity> extends Identifier {
    ...
    /**
     * Sets the value of the '{@link de.fzi.power.binding.AbstractFixedFactorValue#getBoundFactor
     ...
     * @model dataType=
     *        "org.palladiosimulator.edp2.models.ExperimentData.EJSMeasure<org.eclipse.emf.ecore.EDoubleObject, Q>"
     * @generated
     */
    Measure<Double, Q> getValue();

    /**
     * Sets the value of the '{@link de.fzi.power.binding.AbstractFixedFactorValue#getValue
    ...
    /**
     * Sets the value of the '{@link de.fzi.power.binding.AbstractFixedFactorValue#getPowerBinding
