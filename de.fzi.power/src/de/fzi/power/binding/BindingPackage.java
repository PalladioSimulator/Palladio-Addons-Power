...
public interface BindingPackage extends EPackage {
	 ...
	 * @generated
	 */
	BindingPackage eINSTANCE = de.fzi.power.binding.impl.BindingPackageImpl
			.init();
	 ...
	 * {@link de.fzi.power.binding.FixedFactorValue#getBoundFactor <em>Bound Factor</em>}'. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 *
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference FIXED_FACTOR_VALUE__BOUND_FACTOR = eINSTANCE
				.getFixedFactorValue_BoundFactor();
		 ...
		 * @generated
		 */
		EAttribute FIXED_FACTOR_VALUE__VALUE = eINSTANCE
				.getFixedFactorValue_Value();
		 ...
		 * @generated
		 */
		EReference FIXED_FACTOR_VALUE__POWER_BINDING = eINSTANCE
				.getFixedFactorValue_PowerBinding();
		 ...
		 * @generated
		 */
		EReference POWER_BINDING_REPOSITORY__POWER_BINDINGS = eINSTANCE
				.getPowerBindingRepository_PowerBindings();
		 ...
		 * @generated
		 */
		EReference POWER_BINDING__POWER_BINDING_REPOSITORY = eINSTANCE
		 ...
		 * @generated
		 */
		EClass DISTRIBUTION_POWER_BINDING = eINSTANCE
				.getDistributionPowerBinding();
