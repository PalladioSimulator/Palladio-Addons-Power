...
public interface TransitionState extends AbstractPowerState {
    ...
    /**
     * Sets the value of the '{@link de.fzi.power.state.TransitionState#getInitialState
    ...
    /**
     * Sets the value of the '{@link de.fzi.power.state.TransitionState#getTargetState
