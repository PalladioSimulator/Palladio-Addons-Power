...
public class StateAdapterFactory extends AdapterFactoryImpl {
    ...
    protected StateSwitch<Adapter> modelSwitch = new StateSwitch<Adapter>() {
        @Override
        public Adapter casePowerStateRepository(final PowerStateRepository object) {
        ...
        @Override
        public Adapter casePowerStateMachine(final PowerStateMachine object) {
    ...
    /**
     * Creates a new adapter for an object of class '{@link de.fzi.power.state.PowerStateRepository
     * <em>Power State Repository</em>}'. <!-- begin-user-doc --> This default implementation
    ...
    /**
     * Creates a new adapter for an object of class '{@link de.fzi.power.state.AbstractPowerState
    ...
    /**
     * Creates a new adapter for an object of class '{@link de.fzi.power.state.TransitionState
    ...
    /**
     * Creates a new adapter for an object of class '{@link de.fzi.power.state.PowerState
    ...
    /**
     * Creates a new adapter for an object of class '{@link de.fzi.power.state.PowerStateMachine
     * <em>Power State Machine</em>}'. <!-- begin-user-doc --> This default implementation returns
     * null so that we can easily ignore cases; it's useful to ignore a case when inheritance will
     * catch all the cases anyway. <!-- end-user-doc -->
     *
     * @return the new adapter.
