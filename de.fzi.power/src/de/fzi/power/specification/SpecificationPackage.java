...
public interface SpecificationPackage extends EPackage {
	 ...
	 * @generated
	 */
	SpecificationPackage eINSTANCE = de.fzi.power.specification.impl.SpecificationPackageImpl
			.init();
	 ...
	 * @ordered
	 */
	int DECLARATIVE_POWER_MODEL_SPECIFICATION__FUNCTIONAL_EXPRESSION = RESOURCE_POWER_MODEL_SPECIFICATION_FEATURE_COUNT + 0;
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EClass POWER_MODEL_SPECIFICATION = eINSTANCE
				.getPowerModelSpecification();
		 ...
		 * @generated
		 */
		EClass RESOURCE_POWER_MODEL_SPECIFICATION = eINSTANCE
		 ...
		 * @generated
		 */
		EClass DISTRIBUTION_POWER_MODEL_SPECIFICATION = eINSTANCE
				.getDistributionPowerModelSpecification();
		 ...
		 * @generated
		 */
		EReference CONSUMPTION_FACTOR__POWER_MODEL = eINSTANCE
				.getConsumptionFactor_PowerModel();
