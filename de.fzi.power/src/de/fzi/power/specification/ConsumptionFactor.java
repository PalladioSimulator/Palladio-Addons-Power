...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Consumption Factor</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
...
public interface ConsumptionFactor extends Entity {
    /**
     * Returns the value of the '<em><b>Power Model</b></em>' container reference.
     * It is bidirectional and its opposite is '{@link de.fzi.power.specification.PowerModelSpecification#getConsumptionFactors <em>Consumption Factors</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Power Model</em>' container reference isn't clear,
    ...
    /**
     * Sets the value of the '{@link de.fzi.power.specification.ConsumptionFactor#getPowerModel <em>Power Model</em>}' container reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @param value the new value of the '<em>Power Model</em>' container reference.
     * @see #getPowerModel()
     * @generated
     */
