...
public interface MeasuredFactor extends ConsumptionFactor {
    /**
     * Returns the value of the '<em><b>Metric Type</b></em>' reference. <!-- begin-user-doc -->
     * <p>
    ...
    /**
     * Sets the value of the '{@link de.fzi.power.specification.MeasuredFactor#getMetricType
     * <em>Metric Type</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Metric Type</em>' reference.
     * @see #getMetricType()
     * @generated
     */
