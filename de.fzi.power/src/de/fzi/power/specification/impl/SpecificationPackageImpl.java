...
public class SpecificationPackageImpl extends EPackageImpl implements
	...
	public EReference getPowerModelRepository_PowerModelSpecifications() {
		return (EReference) powerModelRepositoryEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public EReference getPowerModelSpecification_Powermodelrepository() {
		return (EReference) powerModelSpecificationEClass
	...
	public EReference getConsumptionFactor_PowerModel() {
		return (EReference) consumptionFactorEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public EReference getMeasuredFactor_MetricType() {
		return (EReference) measuredFactorEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public void createPackageContents() {
		...
		createEReference(consumptionFactorEClass,
	...
	public void initializePackageContents() {
		...
		powerModelRepositoryEClass.getESuperTypes().add(
				theIdentifierPackage.getIdentifier());
		powerModelSpecificationEClass.getESuperTypes().add(
				theUtilPackage.getEntity());
		resourcePowerModelSpecificationEClass.getESuperTypes().add(
				this.getPowerModelSpecification());
		distributionPowerModelSpecificationEClass.getESuperTypes().add(
				this.getPowerModelSpecification());
		...
		declarativePowerModelSpecificationEClass.getESuperTypes().add(
				this.getResourcePowerModelSpecification());
		declarativePowerModelSpecificationEClass.getESuperTypes().add(
				this.getDistributionPowerModelSpecification());

		// Initialize classes and features; add operations and parameters
		initEClass(powerModelRepositoryEClass, PowerModelRepository.class,
				"PowerModelRepository", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPowerModelRepository_PowerModelSpecifications(),
				this.getPowerModelSpecification(),
				this.getPowerModelSpecification_Powermodelrepository(),
				"powerModelSpecifications", null, 0, -1,
				PowerModelRepository.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(powerModelSpecificationEClass,
				PowerModelSpecification.class, "PowerModelSpecification",
				IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPowerModelSpecification_Powermodelrepository(),
				this.getPowerModelRepository(),
				this.getPowerModelRepository_PowerModelSpecifications(),
				"powermodelrepository", null, 0, 1,
				PowerModelSpecification.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPowerModelSpecification_ConsumptionFactors(),
				this.getConsumptionFactor(),
				this.getConsumptionFactor_PowerModel(), "consumptionFactors",
				null, 0, -1, PowerModelSpecification.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(resourcePowerModelSpecificationEClass,
				ResourcePowerModelSpecification.class,
				"ResourcePowerModelSpecification", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(distributionPowerModelSpecificationEClass,
				DistributionPowerModelSpecification.class,
				"DistributionPowerModelSpecification", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(fixedFactorEClass, FixedFactor.class, "FixedFactor",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(consumptionFactorEClass, ConsumptionFactor.class,
				"ConsumptionFactor", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getConsumptionFactor_PowerModel(),
				this.getPowerModelSpecification(),
				this.getPowerModelSpecification_ConsumptionFactors(),
				"powerModel", null, 0, 1, ConsumptionFactor.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		initEClass(measuredFactorEClass, MeasuredFactor.class,
				"MeasuredFactor", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getMeasuredFactor_MetricType(),
