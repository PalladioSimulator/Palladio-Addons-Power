 ...
 * @generated
 */
public abstract class ConsumptionFactorImpl extends EntityImpl implements
		ConsumptionFactor {
	/**
	...
	public PowerModelSpecification getPowerModel() {
		return (PowerModelSpecification) eDynamicGet(
				SpecificationPackage.CONSUMPTION_FACTOR__POWER_MODEL,
				SpecificationPackage.Literals.CONSUMPTION_FACTOR__POWER_MODEL,
				true, true);
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetPowerModel(
			PowerModelSpecification newPowerModel, NotificationChain msgs) {
