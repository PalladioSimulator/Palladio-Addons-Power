 ...
 * @generated
 */
public class PowerModelRepositoryImpl extends IdentifierImpl implements
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case SpecificationPackage.POWER_MODEL_REPOSITORY__POWER_MODEL_SPECIFICATIONS:
			return ((InternalEList<?>) getPowerModelSpecifications())
	...
	public void eSet(int featureID, Object newValue) {
		...
		case SpecificationPackage.POWER_MODEL_REPOSITORY__POWER_MODEL_SPECIFICATIONS:
			...
			getPowerModelSpecifications().addAll(
					(Collection<? extends PowerModelSpecification>) newValue);
			return;
		}
