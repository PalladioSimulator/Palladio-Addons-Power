...
public interface SpecificationFactory extends EFactory {
	 ...
	 * @generated
	 */
	SpecificationFactory eINSTANCE = de.fzi.power.specification.impl.SpecificationFactoryImpl
			.init();

	/**
	 * Returns a new object of class '<em>Power Model Repository</em>'.
	 * <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	...
	/**
	 * Returns a new object of class '<em>Fixed Factor</em>'.
	 * <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	...
	/**
	 * Returns a new object of class '<em>Measured Factor</em>'.
	 * <!-- begin-user-doc --> <!--
	 * end-user-doc -->
