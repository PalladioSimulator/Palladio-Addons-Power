...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Power Model Specification</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link de.fzi.power.specification.PowerModelSpecification#getPowermodelrepository <em>Powermodelrepository</em>}</li>
 *   <li>{@link de.fzi.power.specification.PowerModelSpecification#getConsumptionFactors <em>Consumption Factors</em>}</li>
 * </ul>
 * </p>
 *
...
public interface PowerModelSpecification extends Entity {
    /**
     * Returns the value of the '<em><b>Powermodelrepository</b></em>' container reference.
     * It is bidirectional and its opposite is '{@link de.fzi.power.specification.PowerModelRepository#getPowerModelSpecifications <em>Power Model Specifications</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Powermodelrepository</em>' container reference isn't clear,
    ...
    /**
     * Sets the value of the '{@link de.fzi.power.specification.PowerModelSpecification#getPowermodelrepository <em>Powermodelrepository</em>}' container reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @param value the new value of the '<em>Powermodelrepository</em>' container reference.
     ...
     * The list contents are of type {@link de.fzi.power.specification.ConsumptionFactor}.
     * It is bidirectional and its opposite is '{@link de.fzi.power.specification.ConsumptionFactor#getPowerModel <em>Power Model</em>}'.
     * <!-- begin-user-doc -->
     * <p>
