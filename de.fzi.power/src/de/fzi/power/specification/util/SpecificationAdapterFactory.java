...
public class SpecificationAdapterFactory extends AdapterFactoryImpl {
	...
	protected SpecificationSwitch<Adapter> modelSwitch = new SpecificationSwitch<Adapter>() {
		...
		@Override
		public Adapter casePowerModelSpecification(
				PowerModelSpecification object) {
			return createPowerModelSpecificationAdapter();
		}

		@Override
		public Adapter caseResourcePowerModelSpecification(
				ResourcePowerModelSpecification object) {
			return createResourcePowerModelSpecificationAdapter();
		}

		@Override
		public Adapter caseDistributionPowerModelSpecification(
