...
public class SpecificationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case SpecificationPackage.DECLARATIVE_POWER_MODEL_SPECIFICATION: {
			...
			if (result == null)
				result = caseResourcePowerModelSpecification(declarativePowerModelSpecification);
			if (result == null)
				result = caseDistributionPowerModelSpecification(declarativePowerModelSpecification);
			if (result == null)
