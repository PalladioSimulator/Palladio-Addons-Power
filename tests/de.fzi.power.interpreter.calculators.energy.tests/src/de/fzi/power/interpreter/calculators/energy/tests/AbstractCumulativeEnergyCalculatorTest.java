...
public abstract class AbstractCumulativeEnergyCalculatorTest {
    ...
    public void testSetSamplingPeriod() {
        ...
        assertEquals(expectedSamplingPeriod.doubleValue(SI.SECOND), this.calculatorUnderTest.getSamplingPeriod()
            .doubleValue(SI.SECOND), DELTA);
    }
    ...
    public void testSetOffset() {
        ...
        assertEquals(expectedInitialOffset.doubleValue(SI.SECOND), this.calculatorUnderTest.getInitialOffset()
            .doubleValue(SI.SECOND), DELTA);
    }
    ...
    public void testCalculateNext() {
        ...
        // init step
        Amount<Energy> actual = this.calculatorUnderTest.calculateNext(INPUT_POWER_SAMPLE)
            .to(SI.JOULE);
        ...
        expectedEnergySample = INPUT_POWER_SAMPLE.times(Amount.valueOf(1, SI.SECOND))
            .to(SI.JOULE);
        actual = this.calculatorUnderTest.calculateNext(INPUT_POWER_SAMPLE)
            .to(SI.JOULE);
        assertEquals(expectedEnergySample.doubleValue(SI.JOULE), actual.doubleValue(SI.JOULE), DELTA);
    ...
    public void testGetCurrentlyStoredPowerSamplesCount() {
        ...
        // now the interesting case: 3 are already stored, add a new one, oldest once should be
        // replaced
        this.calculatorUnderTest.calculateNext(INPUT_POWER_SAMPLE);
        assertEquals(3, this.calculatorUnderTest.getPowerSamplesCount());
    }
    ...
    public void testGetCurrentlyStoredEnergySamplesCount() {
        ...
        // now the interesting case: 2 are already stored, calculate a new one, oldest once should
        // be replaced
        this.calculatorUnderTest.calculateNext(INPUT_POWER_SAMPLE);
        assertEquals(2, this.calculatorUnderTest.getEnergySamplesCount());
    }
    ...
    public void testGetOldestEnergySample() {
        ...
        assertEquals(expected.doubleValue(SI.JOULE), this.calculatorUnderTest.getOldestEnergySample()
            .doubleValue(SI.JOULE), DELTA);
        ...
        this.calculatorUnderTest.calculateNext(INPUT_POWER_SAMPLE);
        assertEquals(nextExpected.doubleValue(SI.JOULE), this.calculatorUnderTest.getOldestEnergySample()
            .doubleValue(SI.JOULE), DELTA);
    }
    ...
    public void testGetMostRecentEnergySample() {
        ...
        // up to 2 energy samples are stored
        Amount<Energy> expected = this.calculatorUnderTest.calculateNext(INPUT_POWER_SAMPLE);
        assertEquals(expected.doubleValue(SI.JOULE), this.calculatorUnderTest.getMostRecentEnergySample()
            .doubleValue(SI.JOULE), DELTA);
    ...
    public void testGetEnergySample() {
        ...
        assertEquals(expectedMostRecent.doubleValue(SI.JOULE), this.calculatorUnderTest.getEnergySample(0)
            .doubleValue(SI.JOULE), DELTA);
        ...
        assertEquals(expectedMostRecent.doubleValue(SI.JOULE), this.calculatorUnderTest.getEnergySample(0)
            .doubleValue(SI.JOULE), DELTA);
        assertEquals(expectedLeastRecent.doubleValue(SI.JOULE), this.calculatorUnderTest.getEnergySample(1)
            .doubleValue(SI.JOULE), DELTA);
    ...
    public void testGetOldestPowerSample() {
        ...
        assertEquals(firstInputSample.doubleValue(SI.WATT), this.calculatorUnderTest.getOldestPowerSample()
            .doubleValue(SI.WATT), DELTA);
        ...
        assertEquals(secondInputSample.doubleValue(SI.WATT), this.calculatorUnderTest.getOldestPowerSample()
            .doubleValue(SI.WATT), DELTA);
    }
    ...
    public void testGetMostRecentPowerSample() {
        ...
        this.calculatorUnderTest.calculateNext(firstInputSample);
        assertEquals(firstInputSample.doubleValue(SI.WATT), this.calculatorUnderTest.getMostRecentPowerSample()
            .doubleValue(SI.WATT), DELTA);

        this.calculatorUnderTest.calculateNext(secondInputSample);
        assertEquals(secondInputSample.doubleValue(SI.WATT), this.calculatorUnderTest.getMostRecentPowerSample()
            .doubleValue(SI.WATT), DELTA);

        this.calculatorUnderTest.calculateNext(thirdInputSample);
        assertEquals(thirdInputSample.doubleValue(SI.WATT), this.calculatorUnderTest.getMostRecentPowerSample()
            .doubleValue(SI.WATT), DELTA);

        this.calculatorUnderTest.calculateNext(fourthInputSample);
        assertEquals(fourthInputSample.doubleValue(SI.WATT), this.calculatorUnderTest.getMostRecentPowerSample()
            .doubleValue(SI.WATT), DELTA);
    }
    ...
    public void testGetPowerSample() {
        ...
        // access the most recent
        this.calculatorUnderTest.calculateNext(firstInputSample);
        assertEquals(firstInputSample.doubleValue(SI.WATT), this.calculatorUnderTest.getPowerSample(0)
            .doubleValue(SI.WATT), DELTA);

        // access the last two samples
        this.calculatorUnderTest.calculateNext(secondInputSample);
        assertEquals(secondInputSample.doubleValue(SI.WATT), this.calculatorUnderTest.getPowerSample(0)
            .doubleValue(SI.WATT), DELTA);
        assertEquals(firstInputSample.doubleValue(SI.WATT), this.calculatorUnderTest.getPowerSample(1)
            .doubleValue(SI.WATT), DELTA);

        // access the last three
        this.calculatorUnderTest.calculateNext(thirdInputSample);
        assertEquals(thirdInputSample.doubleValue(SI.WATT), this.calculatorUnderTest.getPowerSample(0)
            .doubleValue(SI.WATT), DELTA);
        assertEquals(secondInputSample.doubleValue(SI.WATT), this.calculatorUnderTest.getPowerSample(1)
            .doubleValue(SI.WATT), DELTA);
        assertEquals(firstInputSample.doubleValue(SI.WATT), this.calculatorUnderTest.getPowerSample(2)
            .doubleValue(SI.WATT), DELTA);

        // again, access the last three
        this.calculatorUnderTest.calculateNext(fourthInputSample);
        assertEquals(fourthInputSample.doubleValue(SI.WATT), this.calculatorUnderTest.getPowerSample(0)
            .doubleValue(SI.WATT), DELTA);
        assertEquals(thirdInputSample.doubleValue(SI.WATT), this.calculatorUnderTest.getPowerSample(1)
            .doubleValue(SI.WATT), DELTA);
        assertEquals(secondInputSample.doubleValue(SI.WATT), this.calculatorUnderTest.getPowerSample(2)
            .doubleValue(SI.WATT), DELTA);
    }
    ...
    private static class MockEnergyCalculator extends AbstractCumulativeEnergyCalculator {
        ...
        protected Amount<Energy> calculateNextInternal() {
            ...
            return getMostRecentPowerSample().times(Amount.valueOf(1, SI.SECOND))
                .to(getResultUnit());
        }
