...
/**
 * <!-- begin-user-doc --> A sample utility for the '<em><b>state</b></em>' package. <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class StateExample {
    ...
    public static void main(final String[] args) {
        ...
        //
        resourceSet.getPackageRegistry().put(StatePackage.eNS_URI, StatePackage.eINSTANCE);
        ...
        if (args.length == 0) {
            ...
            try {
                final Resource resource = resourceSet.createResource(URI.createURI("http:///My.state"));
                final PowerStateRepository root = StateFactory.eINSTANCE.createPowerStateRepository();
