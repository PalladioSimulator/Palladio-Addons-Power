...
import de.fzi.power.util.util.UtilResourceFactoryImpl;
...
public class UtilExample {
    ...
    public static void main(final String[] args) {
        ...
        resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap()
                .put(Resource.Factory.Registry.DEFAULT_EXTENSION, new UtilResourceFactoryImpl());
        ...
        if (args.length == 0) {
            ...
            try {
                final Resource resource = resourceSet.createResource(URI.createURI("http:///My.util"));
                final NamedElement root = UtilFactory.eINSTANCE.createNamedElement();
