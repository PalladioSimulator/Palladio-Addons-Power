...
/**
 * This is the action bar contributor for the Infrastructure model editor. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class InfrastructureActionBarContributor extends EditingDomainActionBarContributor implements
ISelectionChangedListener {
            ...
            PowerEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item"))
    {
        ...
        public void run()
        {
            try
            {
                InfrastructureActionBarContributor.this.getPage().showView("org.eclipse.ui.views.PropertySheet");
            }
            ...
            PowerEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item"))
    {
        ...
        public void run()
        {
            ...
            {
                final Viewer viewer = ((IViewerProvider) InfrastructureActionBarContributor.this.activeEditorPart)
                        .getViewer();
                if (viewer != null)
                {
                    viewer.refresh();
    ...
    public void contributeToMenu(final IMenuManager menuManager) {
        ...
        final IMenuManager submenuManager = new MenuManager(
                PowerEditorPlugin.INSTANCE.getString("_UI_InfrastructureEditor_menu"),
                "de.fzi.power.infrastructureMenuID");
