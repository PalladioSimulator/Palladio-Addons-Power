...
/**
 * This is the action bar contributor for the State model editor. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class StateActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
    /**
    ...
    protected IAction showPropertiesViewAction = new Action(
        ...
        public void run() {
            try {
                StateActionBarContributor.this.getPage().showView("org.eclipse.ui.views.PropertySheet");
    ...
    protected IAction refreshViewerAction = new Action(
        ...
        public boolean isEnabled() {
            return StateActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
        }

        @Override
        public void run() {
            if (StateActionBarContributor.this.activeEditorPart instanceof IViewerProvider) {
                final Viewer viewer = ((IViewerProvider) StateActionBarContributor.this.activeEditorPart).getViewer();
                if (viewer != null) {
                    viewer.refresh();
                }
            }
    ...
    public void contributeToMenu(final IMenuManager menuManager) {
        ...
        final IMenuManager submenuManager = new MenuManager(
                PowerEditorPlugin.INSTANCE.getString("_UI_StateEditor_menu"), "de.fzi.power.stateMenuID");
        ...
        this.createChildMenuManager = new MenuManager(
                PowerEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
