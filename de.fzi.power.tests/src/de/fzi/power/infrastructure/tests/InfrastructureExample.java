...
/**
 * <!-- begin-user-doc --> A sample utility for the '<em><b>infrastructure</b></em>' package. <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class InfrastructureExample {
    ...
    public static void main(final String[] args) {
        ...
        resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap()
                .put(Resource.Factory.Registry.DEFAULT_EXTENSION, new InfrastructureResourceFactoryImpl());
        ...
        if (args.length == 0) {
            ...
            try {
                final Resource resource = resourceSet.createResource(URI.createURI("http:///My.infrastructure"));
                final PowerDistributionUnit root = InfrastructureFactory.eINSTANCE.createPowerDistributionUnit();
