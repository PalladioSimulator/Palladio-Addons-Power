...
public class BindingExample {
    ...
    public static void main(String[] args) {
        ...
        resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap()
                .put(Resource.Factory.Registry.DEFAULT_EXTENSION, new BindingResourceFactoryImpl());

        // Register the package to ensure it is available during loading.
        //
        resourceSet.getPackageRegistry().put(BindingPackage.eNS_URI, BindingPackage.eINSTANCE);
        ...
        if (args.length == 0) {
            ...
            try {
                ...
                FixedFactorValue root = BindingFactory.eINSTANCE.createFixedFactorValue();
