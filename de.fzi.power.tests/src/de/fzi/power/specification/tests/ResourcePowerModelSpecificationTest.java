...
/**
 * <!-- begin-user-doc -->
 * A test case for the model object '<em><b>Resource Power Model Specification</b></em>'.
 * <!-- end-user-doc -->
 * @generated
 */
public class ResourcePowerModelSpecificationTest extends PowerModelSpecificationTest {
     ...
     * @generated
     */
    public ResourcePowerModelSpecificationTest(String name) {
        super(name);
    }
    ...
    protected ResourcePowerModelSpecification getFixture() {
        return (ResourcePowerModelSpecification) fixture;
    }
    ...
    protected void setUp() throws Exception {
        setFixture(SpecificationFactory.eINSTANCE.createResourcePowerModelSpecification());
    }
