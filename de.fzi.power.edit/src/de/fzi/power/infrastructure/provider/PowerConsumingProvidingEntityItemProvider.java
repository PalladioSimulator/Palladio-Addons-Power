 ...
 * @generated
 */
public class PowerConsumingProvidingEntityItemProvider extends
	 ...
	 * @generated
	 */
	public PowerConsumingProvidingEntityItemProvider(
	 ...
	 * @generated
	 */
	protected void addDistributionPowerAssemblyContextPropertyDescriptor(
			Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						((ComposeableAdapterFactory) adapterFactory)
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_PowerConsumingProvidingEntity_type")
				: getString("_UI_PowerConsumingProvidingEntity_type") + " "
						+ label;
	}
