...
/**
 * This is the item provider adapter for a {@link de.fzi.power.infrastructure.PowerConsumingProvidingEntity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PowerConsumingProvidingEntityItemProvider extends PowerConsumingEntityItemProvider {
     ...
     * @generated
     */
    public PowerConsumingProvidingEntityItemProvider(AdapterFactory adapterFactory) {
    ...
    protected void addDistributionPowerAssemblyContextPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getString("_UI_PropertyDescriptor_description",
                        ...
                        "_UI_PowerProvidingEntity_type"),
                InfrastructurePackage.Literals.POWER_PROVIDING_ENTITY__DISTRIBUTION_POWER_ASSEMBLY_CONTEXT, true,
    ...
    public String getText(Object object) {
        String label = ((PowerConsumingProvidingEntity) object).getName();
        return label == null || label.length() == 0 ? getString("_UI_PowerConsumingProvidingEntity_type")
                : getString("_UI_PowerConsumingProvidingEntity_type") + " " + label;
    }
