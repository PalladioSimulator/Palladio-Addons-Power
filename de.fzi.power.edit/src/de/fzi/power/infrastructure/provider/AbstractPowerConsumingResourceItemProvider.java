 ...
 * @generated
 */
public class AbstractPowerConsumingResourceItemProvider extends
	 ...
	 * @generated
	 */
	public AbstractPowerConsumingResourceItemProvider(
	...
	protected void addProcessingResourceSpecificationPropertyDescriptor(
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getResourceLocator(),
						getString("_UI_AbstractPowerConsumingResource_processingResourceSpecification_feature"),
						getString(
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_AbstractPowerConsumingResource_type")
				: getString("_UI_AbstractPowerConsumingResource_type") + " "
						+ label;
	}
