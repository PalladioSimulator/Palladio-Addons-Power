...
public class InfrastructureItemProviderAdapterFactory extends InfrastructureAdapterFactory
    ...
    /**
     * This keeps track of the one adapter used for all
     * {@link de.fzi.power.infrastructure.StatefulPowerConsumingResource} instances. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    ...
    /**
     * This creates an adapter for a
     * {@link de.fzi.power.infrastructure.StatefulPowerConsumingResource}. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
     */
    ...
    public Adapter createStatefulPowerConsumingResourceAdapter() {
        if (this.statefulPowerConsumingResourceItemProvider == null) {
            this.statefulPowerConsumingResourceItemProvider = new StatefulPowerConsumingResourceItemProvider(this);
        }

        return this.statefulPowerConsumingResourceItemProvider;
    }
    ...
    public void dispose() {
        ...
        if (this.statefulPowerConsumingResourceItemProvider != null) {
            this.statefulPowerConsumingResourceItemProvider.dispose();
        }
        if (this.powerConsumingResourceItemProvider != null) {
