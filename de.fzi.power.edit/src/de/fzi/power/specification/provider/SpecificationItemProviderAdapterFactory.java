...
public class SpecificationItemProviderAdapterFactory extends SpecificationAdapterFactory implements
    ...
    public Adapter createPowerModelRepositoryAdapter() {
        if (powerModelRepositoryItemProvider == null) {
            powerModelRepositoryItemProvider = new PowerModelRepositoryItemProvider(this);
        }
    ...
    /**
     * This keeps track of the one adapter used for all {@link de.fzi.power.specification.ResourcePowerModelSpecification} instances.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    public Adapter createResourcePowerModelSpecificationAdapter() {
        if (resourcePowerModelSpecificationItemProvider == null) {
            resourcePowerModelSpecificationItemProvider = new ResourcePowerModelSpecificationItemProvider(this);
        }
    ...
    /**
     * This keeps track of the one adapter used for all {@link de.fzi.power.specification.DistributionPowerModelSpecification} instances.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    public Adapter createDistributionPowerModelSpecificationAdapter() {
        if (distributionPowerModelSpecificationItemProvider == null) {
            distributionPowerModelSpecificationItemProvider = new DistributionPowerModelSpecificationItemProvider(this);
        }
