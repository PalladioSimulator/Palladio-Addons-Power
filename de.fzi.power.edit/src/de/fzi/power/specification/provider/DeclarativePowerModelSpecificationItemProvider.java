 ...
 * @generated
 */
public class DeclarativePowerModelSpecificationItemProvider extends
	 ...
	 * @generated
	 */
	public DeclarativePowerModelSpecificationItemProvider(
	...
	public Object getImage(Object object) {
		return overlayImage(
				...
				getResourceLocator().getImage(
						"full/obj16/DeclarativePowerModelSpecification"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_DeclarativePowerModelSpecification_type")
				: getString("_UI_DeclarativePowerModelSpecification_type")
						+ " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification
				.getFeatureID(DeclarativePowerModelSpecification.class)) {
