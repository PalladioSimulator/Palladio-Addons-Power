...
/**
 * This is the item provider adapter for a {@link de.fzi.power.specification.PowerModelSpecification} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PowerModelSpecificationItemProvider extends EntityItemProvider {
     ...
     * @generated
     */
    public PowerModelSpecificationItemProvider(AdapterFactory adapterFactory) {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(SpecificationPackage.Literals.POWER_MODEL_SPECIFICATION__CONSUMPTION_FACTORS);
        }
    ...
    public String getText(Object object) {
        String label = ((PowerModelSpecification) object).getName();
        return label == null || label.length() == 0 ? getString("_UI_PowerModelSpecification_type")
                : getString("_UI_PowerModelSpecification_type") + " " + label;
    }
