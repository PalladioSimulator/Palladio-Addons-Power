...
public class FixedFactorItemProvider extends ConsumptionFactorItemProvider {
     ...
     * @generated
     */
    public FixedFactorItemProvider(AdapterFactory adapterFactory) {
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/FixedFactor"));
    }
    ...
    public String getText(Object object) {
        String label = ((FixedFactor) object).getName();
        return label == null || label.length() == 0 ? getString("_UI_FixedFactor_type")
                : getString("_UI_FixedFactor_type") + " " + label;
    }
