...
public class BindingItemProviderAdapterFactory extends BindingAdapterFactory
	...
	/**
	 * This keeps track of the one adapter used for all {@link de.fzi.power.binding.FixedFactorValue} instances.
	 * <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * This creates an adapter for a {@link de.fzi.power.binding.FixedFactorValue}. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @generated
	 */
	...
	public Adapter createFixedFactorValueAdapter() {
		if (fixedFactorValueItemProvider == null) {
			fixedFactorValueItemProvider = new FixedFactorValueItemProvider(
					this);
		}

		return fixedFactorValueItemProvider;
	}
	...
	public Adapter createPowerBindingRepositoryAdapter() {
		if (powerBindingRepositoryItemProvider == null) {
			powerBindingRepositoryItemProvider = new PowerBindingRepositoryItemProvider(
					this);
		}
	...
	public Adapter createResourcePowerBindingAdapter() {
		if (resourcePowerBindingItemProvider == null) {
			resourcePowerBindingItemProvider = new ResourcePowerBindingItemProvider(
					this);
		}
	...
	public Adapter createDistributionPowerBindingAdapter() {
		if (distributionPowerBindingItemProvider == null) {
			distributionPowerBindingItemProvider = new DistributionPowerBindingItemProvider(
					this);
		}
	...
	public void dispose() {
		if (fixedFactorValueItemProvider != null)
			fixedFactorValueItemProvider.dispose();
		if (powerBindingRepositoryItemProvider != null)
