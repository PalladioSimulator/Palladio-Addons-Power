 ...
 * @generated
 */
public class StatefulResourcePowerBindingItemProvider extends
	 ...
	 * @generated
	 */
	public StatefulResourcePowerBindingItemProvider(
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(BindingPackage.Literals.STATEFUL_RESOURCE_POWER_BINDING__POWER_STATES);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(
				...
				getResourceLocator().getImage(
						"full/obj16/StatefulResourcePowerBinding"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_StatefulResourcePowerBinding_type")
				: getString("_UI_StatefulResourcePowerBinding_type") + " "
						+ label;
	}
