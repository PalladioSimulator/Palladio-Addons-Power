 ...
 * @generated
 */
public class PowerStateItemProvider extends EntityItemProvider {
	/**
	...
	protected void addBindingPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getResourceLocator(),
						getString("_UI_PowerState_binding_feature"),
						getString("_UI_PropertyDescriptor_description",
								"_UI_PowerState_binding_feature",
								"_UI_PowerState_type"),
						BindingPackage.Literals.POWER_STATE__BINDING, true,
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/PowerState"));
	}
	...
	public String getText(Object object) {
		String label = ((PowerState) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_PowerState_type")
				: getString("_UI_PowerState_type") + " " + label;
	}
