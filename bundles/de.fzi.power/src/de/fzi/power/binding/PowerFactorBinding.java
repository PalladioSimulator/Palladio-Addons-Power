...
public interface PowerFactorBinding extends PowerBinding
{
	 ...
	 * The list contents are of type {@link de.fzi.power.binding.AbstractFixedFactorValue}<code>&lt;?&gt;</code>.
	 * It is bidirectional and its opposite is '{@link de.fzi.power.binding.AbstractFixedFactorValue#getPowerBinding <em>Power Binding</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
