...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Power State Binding</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class PowerStateBindingImpl extends AbstractPowerStateBindingImpl implements PowerStateBinding
{
	...
	{
		return (PowerState)eDynamicGet(BindingPackage.POWER_STATE_BINDING__POWER_STATE, BindingPackage.Literals.POWER_STATE_BINDING__POWER_STATE, true, true);
	}
	...
	{
		return (PowerState)eDynamicGet(BindingPackage.POWER_STATE_BINDING__POWER_STATE, BindingPackage.Literals.POWER_STATE_BINDING__POWER_STATE, false, true);
	}
	...
	{
		eDynamicSet(BindingPackage.POWER_STATE_BINDING__POWER_STATE, BindingPackage.Literals.POWER_STATE_BINDING__POWER_STATE, newPowerState);
	}
	...
	{
		return (ResourcePowerBinding)eDynamicGet(BindingPackage.POWER_STATE_BINDING__BINDING, BindingPackage.Literals.POWER_STATE_BINDING__BINDING, true, true);
	}
	...
	{
		return (ResourcePowerBinding)eDynamicGet(BindingPackage.POWER_STATE_BINDING__BINDING, BindingPackage.Literals.POWER_STATE_BINDING__BINDING, false, true);
	}
	...
	{
		eDynamicSet(BindingPackage.POWER_STATE_BINDING__BINDING, BindingPackage.Literals.POWER_STATE_BINDING__BINDING, newBinding);
	}
