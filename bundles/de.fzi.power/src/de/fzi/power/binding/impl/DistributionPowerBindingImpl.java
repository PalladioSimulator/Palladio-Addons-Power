...
public class DistributionPowerBindingImpl extends PowerFactorBindingImpl implements DistributionPowerBinding
{
	...
	{
		return (DistributionPowerModelSpecification)eDynamicGet(BindingPackage.DISTRIBUTION_POWER_BINDING__DISTRIBUTION_POWER_MODEL, BindingPackage.Literals.DISTRIBUTION_POWER_BINDING__DISTRIBUTION_POWER_MODEL, true, true);
	}
	...
	{
		return (DistributionPowerModelSpecification)eDynamicGet(BindingPackage.DISTRIBUTION_POWER_BINDING__DISTRIBUTION_POWER_MODEL, BindingPackage.Literals.DISTRIBUTION_POWER_BINDING__DISTRIBUTION_POWER_MODEL, false, true);
	}
	...
	{
		eDynamicSet(BindingPackage.DISTRIBUTION_POWER_BINDING__DISTRIBUTION_POWER_MODEL, BindingPackage.Literals.DISTRIBUTION_POWER_BINDING__DISTRIBUTION_POWER_MODEL, newDistributionPowerModel);
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case BindingPackage.DISTRIBUTION_POWER_BINDING__DISTRIBUTION_POWER_MODEL:
				if (resolve) return getDistributionPowerModel();
