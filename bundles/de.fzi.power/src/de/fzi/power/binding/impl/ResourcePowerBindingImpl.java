...
public class ResourcePowerBindingImpl extends PowerFactorBindingImpl implements ResourcePowerBinding
{
	...
	{
		return (ResourcePowerModelSpecification)eDynamicGet(BindingPackage.RESOURCE_POWER_BINDING__RESOURCE_POWER_MODEL_SPECIFICATION, BindingPackage.Literals.RESOURCE_POWER_BINDING__RESOURCE_POWER_MODEL_SPECIFICATION, true, true);
	}
	...
	{
		return (ResourcePowerModelSpecification)eDynamicGet(BindingPackage.RESOURCE_POWER_BINDING__RESOURCE_POWER_MODEL_SPECIFICATION, BindingPackage.Literals.RESOURCE_POWER_BINDING__RESOURCE_POWER_MODEL_SPECIFICATION, false, true);
	}
	...
	{
		eDynamicSet(BindingPackage.RESOURCE_POWER_BINDING__RESOURCE_POWER_MODEL_SPECIFICATION, BindingPackage.Literals.RESOURCE_POWER_BINDING__RESOURCE_POWER_MODEL_SPECIFICATION, newResourcePowerModelSpecification);
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case BindingPackage.RESOURCE_POWER_BINDING__RESOURCE_POWER_MODEL_SPECIFICATION:
				if (resolve) return getResourcePowerModelSpecification();
