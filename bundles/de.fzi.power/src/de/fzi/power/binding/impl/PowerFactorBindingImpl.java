...
public abstract class PowerFactorBindingImpl extends PowerBindingImpl implements PowerFactorBinding
{
	...
	{
		return (EList<AbstractFixedFactorValue<?>>)eDynamicGet(BindingPackage.POWER_FACTOR_BINDING__FIXED_FACTOR_VALUES, BindingPackage.Literals.POWER_FACTOR_BINDING__FIXED_FACTOR_VALUES, true, true);
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case BindingPackage.POWER_FACTOR_BINDING__FIXED_FACTOR_VALUES:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getFixedFactorValues()).basicAdd(otherEnd, msgs);
		}
