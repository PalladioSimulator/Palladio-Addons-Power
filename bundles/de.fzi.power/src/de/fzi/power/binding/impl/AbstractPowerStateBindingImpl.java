...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Abstract Power State Binding</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public abstract class AbstractPowerStateBindingImpl extends EntityImpl implements AbstractPowerStateBinding
{
	...
	{
		return (StatefulResourcePowerBinding)eDynamicGet(BindingPackage.ABSTRACT_POWER_STATE_BINDING__STATEFUL_RESOURCE_POWER_BINDING, BindingPackage.Literals.ABSTRACT_POWER_STATE_BINDING__STATEFUL_RESOURCE_POWER_BINDING, true, true);
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetStatefulResourcePowerBinding(StatefulResourcePowerBinding newStatefulResourcePowerBinding, NotificationChain msgs)
	{
		msgs = eBasicSetContainer((InternalEObject)newStatefulResourcePowerBinding, BindingPackage.ABSTRACT_POWER_STATE_BINDING__STATEFUL_RESOURCE_POWER_BINDING, msgs);
		return msgs;
	}
	...
	{
		eDynamicSet(BindingPackage.ABSTRACT_POWER_STATE_BINDING__STATEFUL_RESOURCE_POWER_BINDING, BindingPackage.Literals.ABSTRACT_POWER_STATE_BINDING__STATEFUL_RESOURCE_POWER_BINDING, newStatefulResourcePowerBinding);
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs)
	{
		...
		{
			case BindingPackage.ABSTRACT_POWER_STATE_BINDING__STATEFUL_RESOURCE_POWER_BINDING:
				return eInternalContainer().eInverseRemove(this, BindingPackage.STATEFUL_RESOURCE_POWER_BINDING__POWER_STATE_BINDINGS, StatefulResourcePowerBinding.class, msgs);
		}
