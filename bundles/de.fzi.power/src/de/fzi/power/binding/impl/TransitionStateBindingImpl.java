...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Transition State Binding</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class TransitionStateBindingImpl extends AbstractPowerStateBindingImpl implements TransitionStateBinding
{
	...
	{
		return (TransitionState)eDynamicGet(BindingPackage.TRANSITION_STATE_BINDING__TRANSITION_STATE, BindingPackage.Literals.TRANSITION_STATE_BINDING__TRANSITION_STATE, true, true);
	}
	...
	{
		return (TransitionState)eDynamicGet(BindingPackage.TRANSITION_STATE_BINDING__TRANSITION_STATE, BindingPackage.Literals.TRANSITION_STATE_BINDING__TRANSITION_STATE, false, true);
	}
	...
	{
		eDynamicSet(BindingPackage.TRANSITION_STATE_BINDING__TRANSITION_STATE, BindingPackage.Literals.TRANSITION_STATE_BINDING__TRANSITION_STATE, newTransitionState);
	}
	...
	{
		return (ConsumptionBehavior)eDynamicGet(BindingPackage.TRANSITION_STATE_BINDING__TRANSITION_CONSUMPTION, BindingPackage.Literals.TRANSITION_STATE_BINDING__TRANSITION_CONSUMPTION, true, true);
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetTransitionConsumption(ConsumptionBehavior newTransitionConsumption, NotificationChain msgs)
	{
		msgs = eDynamicInverseAdd((InternalEObject)newTransitionConsumption, BindingPackage.TRANSITION_STATE_BINDING__TRANSITION_CONSUMPTION, msgs);
		return msgs;
	}
	...
	{
		eDynamicSet(BindingPackage.TRANSITION_STATE_BINDING__TRANSITION_CONSUMPTION, BindingPackage.Literals.TRANSITION_STATE_BINDING__TRANSITION_CONSUMPTION, newTransitionConsumption);
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case BindingPackage.TRANSITION_STATE_BINDING__TRANSITION_STATE:
				if (resolve) return getTransitionState();
