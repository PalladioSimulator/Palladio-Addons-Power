...
public class PowerBindingRepositoryImpl extends IdentifierImpl implements PowerBindingRepository
{
	...
	{
		return (EList<PowerBinding>)eDynamicGet(BindingPackage.POWER_BINDING_REPOSITORY__POWER_BINDINGS, BindingPackage.Literals.POWER_BINDING_REPOSITORY__POWER_BINDINGS, true, true);
	}
