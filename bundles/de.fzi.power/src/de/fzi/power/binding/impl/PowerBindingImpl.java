...
public abstract class PowerBindingImpl extends EntityImpl implements PowerBinding
{
	...
	{
		return (PowerBindingRepository)eDynamicGet(BindingPackage.POWER_BINDING__POWER_BINDING_REPOSITORY, BindingPackage.Literals.POWER_BINDING__POWER_BINDING_REPOSITORY, true, true);
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetPowerBindingRepository(PowerBindingRepository newPowerBindingRepository, NotificationChain msgs)
	{
		msgs = eBasicSetContainer((InternalEObject)newPowerBindingRepository, BindingPackage.POWER_BINDING__POWER_BINDING_REPOSITORY, msgs);
		return msgs;
	}
	...
	{
		eDynamicSet(BindingPackage.POWER_BINDING__POWER_BINDING_REPOSITORY, BindingPackage.Literals.POWER_BINDING__POWER_BINDING_REPOSITORY, newPowerBindingRepository);
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs)
	{
		...
		{
			case BindingPackage.POWER_BINDING__POWER_BINDING_REPOSITORY:
				return eInternalContainer().eInverseRemove(this, BindingPackage.POWER_BINDING_REPOSITORY__POWER_BINDINGS, PowerBindingRepository.class, msgs);
		}
