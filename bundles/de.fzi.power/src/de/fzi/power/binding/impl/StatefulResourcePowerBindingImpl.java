...
public class StatefulResourcePowerBindingImpl extends PowerBindingImpl implements StatefulResourcePowerBinding
{
	...
	{
		return (PowerStateMachine)eDynamicGet(BindingPackage.STATEFUL_RESOURCE_POWER_BINDING__POWER_STATE_MACHINE, BindingPackage.Literals.STATEFUL_RESOURCE_POWER_BINDING__POWER_STATE_MACHINE, true, true);
	}
	...
	{
		return (PowerStateMachine)eDynamicGet(BindingPackage.STATEFUL_RESOURCE_POWER_BINDING__POWER_STATE_MACHINE, BindingPackage.Literals.STATEFUL_RESOURCE_POWER_BINDING__POWER_STATE_MACHINE, false, true);
	}
	...
	{
		eDynamicSet(BindingPackage.STATEFUL_RESOURCE_POWER_BINDING__POWER_STATE_MACHINE, BindingPackage.Literals.STATEFUL_RESOURCE_POWER_BINDING__POWER_STATE_MACHINE, newPowerStateMachine);
	}
	...
	{
		return (EList<AbstractPowerStateBinding>)eDynamicGet(BindingPackage.STATEFUL_RESOURCE_POWER_BINDING__POWER_STATE_BINDINGS, BindingPackage.Literals.STATEFUL_RESOURCE_POWER_BINDING__POWER_STATE_BINDINGS, true, true);
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case BindingPackage.STATEFUL_RESOURCE_POWER_BINDING__POWER_STATE_BINDINGS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getPowerStateBindings()).basicAdd(otherEnd, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case BindingPackage.STATEFUL_RESOURCE_POWER_BINDING__POWER_STATE_MACHINE:
				if (resolve) return getPowerStateMachine();
