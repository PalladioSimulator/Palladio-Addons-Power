	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID)
		{
			case StatePackage.POWER_STATE_REPOSITORY:
			{
				...
				if (result == null) result = caseEntity(powerStateRepository);
				if (result == null) result = caseIdentifier(powerStateRepository);
				if (result == null) result = caseNamedElement(powerStateRepository);
			...
			case StatePackage.ABSTRACT_POWER_STATE:
			{
				...
				if (result == null) result = caseEntity(abstractPowerState);
				if (result == null) result = caseIdentifier(abstractPowerState);
				if (result == null) result = caseNamedElement(abstractPowerState);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StatePackage.TRANSITION_STATE:
			{
				...
				if (result == null) result = caseAbstractPowerState(transitionState);
				if (result == null) result = caseEntity(transitionState);
				if (result == null) result = caseIdentifier(transitionState);
				if (result == null) result = caseNamedElement(transitionState);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StatePackage.POWER_STATE:
			{
				...
				if (result == null) result = caseAbstractPowerState(powerState);
				if (result == null) result = caseEntity(powerState);
				if (result == null) result = caseIdentifier(powerState);
				if (result == null) result = caseNamedElement(powerState);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StatePackage.POWER_STATE_MACHINE:
			{
				...
				if (result == null) result = caseEntity(powerStateMachine);
				if (result == null) result = caseIdentifier(powerStateMachine);
				if (result == null) result = caseNamedElement(powerStateMachine);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
