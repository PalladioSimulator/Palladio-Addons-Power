...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Power State Repository</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class PowerStateRepositoryImpl extends EntityImpl implements PowerStateRepository
{
	...
	{
		return (EList<PowerStateMachine>)eDynamicGet(StatePackage.POWER_STATE_REPOSITORY__POWER_STATE_MACHINES, StatePackage.Literals.POWER_STATE_REPOSITORY__POWER_STATE_MACHINES, true, true);
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case StatePackage.POWER_STATE_REPOSITORY__POWER_STATE_MACHINES:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getPowerStateMachines()).basicAdd(otherEnd, msgs);
		}
