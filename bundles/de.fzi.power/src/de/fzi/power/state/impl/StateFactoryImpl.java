...
public class StateFactoryImpl extends EFactoryImpl implements StateFactory
{
	...
	public EObject create(EClass eClass)
	{
		...
		{
			case StatePackage.POWER_STATE_REPOSITORY: return (EObject)createPowerStateRepository();
			case StatePackage.TRANSITION_STATE: return (EObject)createTransitionState();
			case StatePackage.POWER_STATE: return (EObject)createPowerState();
			case StatePackage.POWER_STATE_MACHINE: return (EObject)createPowerStateMachine();
			default:
