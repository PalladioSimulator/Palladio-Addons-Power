...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Power State Machine</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class PowerStateMachineImpl extends EntityImpl implements PowerStateMachine
{
	...
	{
		return (PowerStateRepository)eDynamicGet(StatePackage.POWER_STATE_MACHINE__POWER_STATE_REPOSITORY, StatePackage.Literals.POWER_STATE_MACHINE__POWER_STATE_REPOSITORY, true, true);
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetPowerStateRepository(PowerStateRepository newPowerStateRepository, NotificationChain msgs)
	{
		msgs = eBasicSetContainer((InternalEObject)newPowerStateRepository, StatePackage.POWER_STATE_MACHINE__POWER_STATE_REPOSITORY, msgs);
		return msgs;
	}
	...
	{
		eDynamicSet(StatePackage.POWER_STATE_MACHINE__POWER_STATE_REPOSITORY, StatePackage.Literals.POWER_STATE_MACHINE__POWER_STATE_REPOSITORY, newPowerStateRepository);
	}
	...
	{
		return (EList<AbstractPowerState>)eDynamicGet(StatePackage.POWER_STATE_MACHINE__POWER_STATES, StatePackage.Literals.POWER_STATE_MACHINE__POWER_STATES, true, true);
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs)
	{
		...
		{
			case StatePackage.POWER_STATE_MACHINE__POWER_STATE_REPOSITORY:
				return eInternalContainer().eInverseRemove(this, StatePackage.POWER_STATE_REPOSITORY__POWER_STATE_MACHINES, PowerStateRepository.class, msgs);
		}
