...
public class StatePackageImpl extends EPackageImpl implements StatePackage
{
	...
	public static StatePackage init()
	{
		...
		Object registeredStatePackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		StatePackageImpl theStatePackage = registeredStatePackage instanceof StatePackageImpl ? (StatePackageImpl)registeredStatePackage : new StatePackageImpl();
		...
		registeredPackage = EPackage.Registry.INSTANCE.getEPackage(BindingPackage.eNS_URI);
	...
	public void initializePackageContents()
	{
		...
		initEClass(powerStateRepositoryEClass, PowerStateRepository.class, "PowerStateRepository", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPowerStateRepository_PowerStateMachines(), this.getPowerStateMachine(), this.getPowerStateMachine_PowerStateRepository(), "powerStateMachines", null, 0, -1, PowerStateRepository.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(abstractPowerStateEClass, AbstractPowerState.class, "AbstractPowerState", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getAbstractPowerState_PowerStateMachine(), this.getPowerStateMachine(), this.getPowerStateMachine_PowerStates(), "powerStateMachine", null, 0, 1, AbstractPowerState.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTransitionState_InitialState(), this.getPowerState(), null, "initialState", null, 1, 1, TransitionState.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTransitionState_TargetState(), this.getPowerState(), null, "targetState", null, 1, 1, TransitionState.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(powerStateEClass, PowerState.class, "PowerState", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(powerStateMachineEClass, PowerStateMachine.class, "PowerStateMachine", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPowerStateMachine_PowerStateRepository(), this.getPowerStateRepository(), this.getPowerStateRepository_PowerStateMachines(), "powerStateRepository", null, 0, 1, PowerStateMachine.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPowerStateMachine_PowerStates(), this.getAbstractPowerState(), this.getAbstractPowerState_PowerStateMachine(), "powerStates", null, 1, -1, PowerStateMachine.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
