...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Abstract Power State</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public abstract class AbstractPowerStateImpl extends EntityImpl implements AbstractPowerState
{
	...
	{
		return (PowerStateMachine)eDynamicGet(StatePackage.ABSTRACT_POWER_STATE__POWER_STATE_MACHINE, StatePackage.Literals.ABSTRACT_POWER_STATE__POWER_STATE_MACHINE, true, true);
	}
	...
	{
		msgs = eBasicSetContainer((InternalEObject)newPowerStateMachine, StatePackage.ABSTRACT_POWER_STATE__POWER_STATE_MACHINE, msgs);
		return msgs;
	}
	...
	{
		eDynamicSet(StatePackage.ABSTRACT_POWER_STATE__POWER_STATE_MACHINE, StatePackage.Literals.ABSTRACT_POWER_STATE__POWER_STATE_MACHINE, newPowerStateMachine);
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs)
	{
		...
		{
			case StatePackage.ABSTRACT_POWER_STATE__POWER_STATE_MACHINE:
				return eInternalContainer().eInverseRemove(this, StatePackage.POWER_STATE_MACHINE__POWER_STATES, PowerStateMachine.class, msgs);
		}
