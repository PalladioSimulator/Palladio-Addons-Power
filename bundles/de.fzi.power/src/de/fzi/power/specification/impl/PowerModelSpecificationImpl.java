...
public abstract class PowerModelSpecificationImpl extends EntityImpl implements PowerModelSpecification
{
	...
	{
		return (PowerModelRepository)eDynamicGet(SpecificationPackage.POWER_MODEL_SPECIFICATION__POWERMODELREPOSITORY, SpecificationPackage.Literals.POWER_MODEL_SPECIFICATION__POWERMODELREPOSITORY, true, true);
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetPowermodelrepository(PowerModelRepository newPowermodelrepository, NotificationChain msgs)
	{
		msgs = eBasicSetContainer((InternalEObject)newPowermodelrepository, SpecificationPackage.POWER_MODEL_SPECIFICATION__POWERMODELREPOSITORY, msgs);
		return msgs;
	}
	...
	{
		eDynamicSet(SpecificationPackage.POWER_MODEL_SPECIFICATION__POWERMODELREPOSITORY, SpecificationPackage.Literals.POWER_MODEL_SPECIFICATION__POWERMODELREPOSITORY, newPowermodelrepository);
	}
	...
	{
		return (EList<ConsumptionFactor>)eDynamicGet(SpecificationPackage.POWER_MODEL_SPECIFICATION__CONSUMPTION_FACTORS, SpecificationPackage.Literals.POWER_MODEL_SPECIFICATION__CONSUMPTION_FACTORS, true, true);
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			...
			case SpecificationPackage.POWER_MODEL_SPECIFICATION__CONSUMPTION_FACTORS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getConsumptionFactors()).basicAdd(otherEnd, msgs);
		}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs)
	{
		...
		{
			case SpecificationPackage.POWER_MODEL_SPECIFICATION__POWERMODELREPOSITORY:
				return eInternalContainer().eInverseRemove(this, SpecificationPackage.POWER_MODEL_REPOSITORY__POWER_MODEL_SPECIFICATIONS, PowerModelRepository.class, msgs);
		}
