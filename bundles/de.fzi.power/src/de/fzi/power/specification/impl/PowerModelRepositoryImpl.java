...
public class PowerModelRepositoryImpl extends IdentifierImpl implements PowerModelRepository
{
	...
	{
		return (EList<PowerModelSpecification>)eDynamicGet(SpecificationPackage.POWER_MODEL_REPOSITORY__POWER_MODEL_SPECIFICATIONS, SpecificationPackage.Literals.POWER_MODEL_REPOSITORY__POWER_MODEL_SPECIFICATIONS, true, true);
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case SpecificationPackage.POWER_MODEL_REPOSITORY__POWER_MODEL_SPECIFICATIONS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getPowerModelSpecifications()).basicAdd(otherEnd, msgs);
		}
