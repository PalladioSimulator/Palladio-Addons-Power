...
public abstract class ConsumptionFactorImpl extends EntityImpl implements ConsumptionFactor
{
	...
	{
		return (PowerModelSpecification)eDynamicGet(SpecificationPackage.CONSUMPTION_FACTOR__POWER_MODEL, SpecificationPackage.Literals.CONSUMPTION_FACTOR__POWER_MODEL, true, true);
	}
	...
	{
		msgs = eBasicSetContainer((InternalEObject)newPowerModel, SpecificationPackage.CONSUMPTION_FACTOR__POWER_MODEL, msgs);
		return msgs;
	}
	...
	{
		eDynamicSet(SpecificationPackage.CONSUMPTION_FACTOR__POWER_MODEL, SpecificationPackage.Literals.CONSUMPTION_FACTOR__POWER_MODEL, newPowerModel);
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs)
	{
		...
		{
			case SpecificationPackage.CONSUMPTION_FACTOR__POWER_MODEL:
				return eInternalContainer().eInverseRemove(this, SpecificationPackage.POWER_MODEL_SPECIFICATION__CONSUMPTION_FACTORS, PowerModelSpecification.class, msgs);
		}
