...
public abstract class PowerConsumingEntityImpl extends EntityImpl implements PowerConsumingEntity
{
	...
	{
		return (PowerProvidingEntity)eDynamicGet(InfrastructurePackage.POWER_CONSUMING_ENTITY__POWER_PROVIDING_ENTITY, InfrastructurePackage.Literals.POWER_CONSUMING_ENTITY__POWER_PROVIDING_ENTITY, true, true);
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetPowerProvidingEntity(PowerProvidingEntity newPowerProvidingEntity, NotificationChain msgs)
	{
		msgs = eBasicSetContainer((InternalEObject)newPowerProvidingEntity, InfrastructurePackage.POWER_CONSUMING_ENTITY__POWER_PROVIDING_ENTITY, msgs);
		return msgs;
	}
	...
	{
		eDynamicSet(InfrastructurePackage.POWER_CONSUMING_ENTITY__POWER_PROVIDING_ENTITY, InfrastructurePackage.Literals.POWER_CONSUMING_ENTITY__POWER_PROVIDING_ENTITY, newPowerProvidingEntity);
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs)
	{
		...
		{
			case InfrastructurePackage.POWER_CONSUMING_ENTITY__POWER_PROVIDING_ENTITY:
				return eInternalContainer().eInverseRemove(this, InfrastructurePackage.POWER_PROVIDING_ENTITY__NESTED_POWER_CONSUMING_ENTITIES, PowerProvidingEntity.class, msgs);
		}
