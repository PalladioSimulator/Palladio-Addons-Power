...
public class MountedPowerDistributionUnitImpl extends PowerDistributionUnitImpl implements MountedPowerDistributionUnit
{
	...
	{
		return (ResourceContainer)eDynamicGet(InfrastructurePackage.MOUNTED_POWER_DISTRIBUTION_UNIT__RESOURCE_CONTAINER, InfrastructurePackage.Literals.MOUNTED_POWER_DISTRIBUTION_UNIT__RESOURCE_CONTAINER, true, true);
	}
	...
	{
		return (ResourceContainer)eDynamicGet(InfrastructurePackage.MOUNTED_POWER_DISTRIBUTION_UNIT__RESOURCE_CONTAINER, InfrastructurePackage.Literals.MOUNTED_POWER_DISTRIBUTION_UNIT__RESOURCE_CONTAINER, false, true);
	}
	...
	{
		eDynamicSet(InfrastructurePackage.MOUNTED_POWER_DISTRIBUTION_UNIT__RESOURCE_CONTAINER, InfrastructurePackage.Literals.MOUNTED_POWER_DISTRIBUTION_UNIT__RESOURCE_CONTAINER, newResourceContainer);
	}
