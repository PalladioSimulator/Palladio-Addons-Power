...
public class StatefulPowerConsumingResourceSetImpl extends AbstractPowerConsumingResourceImpl implements StatefulPowerConsumingResourceSet
{
	...
	{
		return (AbstractPowerStateBinding)eDynamicGet(InfrastructurePackage.STATEFUL_POWER_CONSUMING_RESOURCE_SET__POWER_STATE, InfrastructurePackage.Literals.STATEFUL_POWER_CONSUMING_RESOURCE_SET__POWER_STATE, true, true);
	}
	...
	{
		return (AbstractPowerStateBinding)eDynamicGet(InfrastructurePackage.STATEFUL_POWER_CONSUMING_RESOURCE_SET__POWER_STATE, InfrastructurePackage.Literals.STATEFUL_POWER_CONSUMING_RESOURCE_SET__POWER_STATE, false, true);
	}
	...
	{
		eDynamicSet(InfrastructurePackage.STATEFUL_POWER_CONSUMING_RESOURCE_SET__POWER_STATE, InfrastructurePackage.Literals.STATEFUL_POWER_CONSUMING_RESOURCE_SET__POWER_STATE, newPowerState);
	}
	...
	{
		return (StatefulResourcePowerBinding)eDynamicGet(InfrastructurePackage.STATEFUL_POWER_CONSUMING_RESOURCE_SET__STATEFUL_RESOURCE_POWER_BINDING, InfrastructurePackage.Literals.STATEFUL_POWER_CONSUMING_RESOURCE_SET__STATEFUL_RESOURCE_POWER_BINDING, true, true);
	}
	...
	{
		return (StatefulResourcePowerBinding)eDynamicGet(InfrastructurePackage.STATEFUL_POWER_CONSUMING_RESOURCE_SET__STATEFUL_RESOURCE_POWER_BINDING, InfrastructurePackage.Literals.STATEFUL_POWER_CONSUMING_RESOURCE_SET__STATEFUL_RESOURCE_POWER_BINDING, false, true);
	}
	...
	{
		eDynamicSet(InfrastructurePackage.STATEFUL_POWER_CONSUMING_RESOURCE_SET__STATEFUL_RESOURCE_POWER_BINDING, InfrastructurePackage.Literals.STATEFUL_POWER_CONSUMING_RESOURCE_SET__STATEFUL_RESOURCE_POWER_BINDING, newStatefulResourcePowerBinding);
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case InfrastructurePackage.STATEFUL_POWER_CONSUMING_RESOURCE_SET__POWER_STATE:
				if (resolve) return getPowerState();
			...
			case InfrastructurePackage.STATEFUL_POWER_CONSUMING_RESOURCE_SET__STATEFUL_RESOURCE_POWER_BINDING:
				if (resolve) return getStatefulResourcePowerBinding();
