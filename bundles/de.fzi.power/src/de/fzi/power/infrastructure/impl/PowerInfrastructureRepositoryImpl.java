...
public class PowerInfrastructureRepositoryImpl extends CDOObjectImpl implements PowerInfrastructureRepository
{
	...
	{
		return (EList<PowerProvidingEntity>)eDynamicGet(InfrastructurePackage.POWER_INFRASTRUCTURE_REPOSITORY__CONTAINED_POWER_PROVIDING_ENTITIES, InfrastructurePackage.Literals.POWER_INFRASTRUCTURE_REPOSITORY__CONTAINED_POWER_PROVIDING_ENTITIES, true, true);
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case InfrastructurePackage.POWER_INFRASTRUCTURE_REPOSITORY__CONTAINED_POWER_PROVIDING_ENTITIES:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getContainedPowerProvidingEntities()).basicAdd(otherEnd, msgs);
		}
