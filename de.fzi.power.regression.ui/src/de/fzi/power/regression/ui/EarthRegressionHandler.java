...
public class EarthRegressionHandler extends AbstractHandler {
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        if(treeSelection.getFirstElement() instanceof PowerBindingRepository) {
            ...
            Job job = new Job("Inferring EARTH power model from measurements in EDP2 repository") {
    ...
    private void openDialog(ExecutionEvent event, PowerBindingRepository repo, Repositories repositories) {
        Display.getDefault().syncExec(new Runnable() {
            public void run() {
                EarthPowerModelExtractorWizard extractorWizard = new EarthPowerModelExtractorWizard(repo, repositories);
